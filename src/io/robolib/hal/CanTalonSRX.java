...
public class CanTalonSRX extends CtreCanNode {
  ...
  public SWIGTYPE_p_CTR_Code SetModeSelect(int param) {
    return new SWIGTYPE_p_CTR_Code(CanTalonJNI.CanTalonSRX_SetModeSelect__SWIG_0(swigCPtr, this, param), true);
  }

  public SWIGTYPE_p_CTR_Code SetModeSelect(int modeSelect, int demand) {
    return new SWIGTYPE_p_CTR_Code(CanTalonJNI.CanTalonSRX_SetModeSelect__SWIG_1(swigCPtr, this, modeSelect, demand), true);
  }
