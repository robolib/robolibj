...
public class NetworkCommunications extends JNIWrapper {
	...
	public static interface tTargetClass {
		...
		public static final int kTargetClass_FRC2_Analog = NetworkCommunications.tTargetClass.kTargetClass_FRC2
				| NetworkCommunications.tModuleType.kModuleType_Analog;
		public static final int kTargetClass_FRC2_Digital = NetworkCommunications.tTargetClass.kTargetClass_FRC2
				| NetworkCommunications.tModuleType.kModuleType_Digital;
		public static final int kTargetClass_FRC2_Solenoid = NetworkCommunications.tTargetClass.kTargetClass_FRC2
				| NetworkCommunications.tModuleType.kModuleType_Solenoid;
	...
	/**
	 * Original signature :
	 * <code>uint32_t FRC_NetworkCommunication_nAICalibration_getLSBWeight(const uint32_t, const uint32_t, int32_t*)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int32_t FRC_NetworkCommunication_nAICalibration_getOffset(const uint32_t, const uint32_t, int32_t*)</code><br>
	 * <i>native declaration :
	...
	/**
	 * Original signature :
	 * <code>uint32_t FRC_NetworkCommunication_nLoadOut_getModulePresence(uint32_t, uint8_t)</code><br>
	 * <i>native declaration :
	 ...
	 *
	 * @param resource       one of the values in the UsageReporting above (max
	 *                       value 51).
	 * @param instanceNumber an index that identifies the resource instance.
	 * @param context        an optional additional context number for some cases
	 *                       (such as module number). Set to 0 to omit.
	 * @param feature        a string to be included describing features in use on a
	 *                       specific resource. Setting the same resource more than
	 *                       once allows you to change the feature string.<br>
	 *                       Original signature :
	 *                       <code>uint32_t report(UsageReporting, uint8_t, uint8_t, const char*)</code><br>
	 *                       <i>native declaration :
