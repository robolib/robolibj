...
/**
 * An adapter that is used to filter value change notifications for a specific
 * key
 */
public class NTKeyListenerAdapter implements ITableListener {
     ...
     * 
     * @param relativeKey    the name of the key relative to the table (this is what
     *                       the listener will receiver as the key)
     ...
     */
    public NTKeyListenerAdapter(String relativeKey, String fullKey, NetworkTable targetSource,
