...
public class NTThread {
    ...
    public static interface NTRunnable {
         ...
         *
         * @throws InterruptedException thrown when the thread is supposed to be
         *                              interrupted and stop (implementers should always
         *                              let this exception fall through)
         */
     ...
     * @return a thread that will run the provided runnable repeatedly with the
     *         assumption that the runnable will block
     */
