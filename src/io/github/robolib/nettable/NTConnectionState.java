...
public class NTConnectionState {
     ...
     */
    public static final NTConnectionState GOT_CONNECTION_FROM_CLIENT = new NTConnectionState(
    ...
    public static class Error extends NTConnectionState {
        ...
        /**
         * @return the exception that caused the client connection to enter an error
         *         state
         */
