...
public class NTTableEntry {
    ...
    /**
     * Create a new entry with the given name, type, value, an unknown id and a
     ...
     * @param value
     */
    public NTTableEntry(final char id, final String name, final char sequenceNumber, final NTEntryType type,
            final Object value) {
        m_id = id;
        m_name = name;
    ...
    /**
     * set the value of the entry if the given sequence number is greater that the
    ...
    /**
     * force a value and new sequence number upon an entry, Will also set the type
     * of the entry
     * 
     * @param newSequenceNumber
     * @param type
    ...
    public String toString() {
        return "Network Table " + m_type.name + " entry: " + m_name + ": " + (int) getId() + " - "
                + (int) getSequenceNumber() + " - " + getValue();
    }
