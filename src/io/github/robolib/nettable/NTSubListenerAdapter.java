...
/**
 * An adapter that is used to filter sub table change notifications and make the
        ...
        if (key.startsWith(m_prefix)) {
            ...
            if (endSubTable != -1) {
                ...
                if (!m_notifiedTables.contains(subTableKey)) {
                    ...
                    m_targetListener.valueChanged(m_targetSource, subTableKey, m_targetSource.getSubTable(subTableKey),
                            true);
                }
            }
        }
