...
import edu.wpi.first.wpilibj.networktables.NTMessageType;
import edu.wpi.first.wpilibj.networktables.server.ConnectionAdapter;
import edu.wpi.first.wpilibj.networktables.server.SocketStream;
...
public class NTConnection {
	...
	public final SocketStream m_stream;
	private final NTEntryTypeManager m_typeManager;
	private boolean m_isValid;

	
	public NTConnection(SocketStream stream, NTEntryTypeManager typeManager){
		m_stream = stream;
